    ...
    <div className="features">
      <div className="feature-item">
        ...
        <span className="description">
          ...
          INSTITUT DE FORMATION PROFESSIONNEL POLYTECH PRIVEE , vous pouvez
          avoir un professeur qui peut vous assurer des cours dont vous avez
          besoin et avec un niveau de qualité remarquable.​
        </span>
      </div>
      <div className="feature-item">
        <h2>
          Notre INSTITUT DE FORMATION PROFESSIONNEL POLYTECH PRIVEE vous assure
          la préparation des concours selon le nouveau programme
        </h2>
        <span className="description">
